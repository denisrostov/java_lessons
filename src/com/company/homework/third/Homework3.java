...
public class Homework3 {
    ...
    public static void ex1() {
        ConiferousTree pine = new ConiferousTree(50, "large");
        ConiferousTree fir = new ConiferousTree(60, "small");
        DeciduousTree birch = new DeciduousTree(40, true);

        birch.flower();

        Tree[] trees = {pine, fir, birch};
        int totalAge = 0;
        for (Tree tree : trees) {
            totalAge += tree.getAge();
        }

        System.out.println("Средний возраст: " + (double) totalAge / trees.length);
    ...
    public static void ex4() {
        ...
        for (int i = 0; i < tickets.length; i++) {
            ...
            int prize = tickets[i].checkLuck();
            System.out.println("Приз для билета " + (i + 1) + ": " + prize);
        }
    }
